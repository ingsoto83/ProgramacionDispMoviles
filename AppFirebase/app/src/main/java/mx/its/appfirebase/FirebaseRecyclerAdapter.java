...
public abstract class FirebaseRecyclerAdapter<ViewHolder extends RecyclerView.ViewHolder, T>
    ...
    /**
     * Called after an item has been send to the adapter
     *
     * @param item     Added item
     * @param key      Key of the send item
     * @param position Position of the send item in the adapter
     */
